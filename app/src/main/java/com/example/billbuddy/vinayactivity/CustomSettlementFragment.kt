...
class CustomSettlementFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d("CustomeSettlement","$friendName")
        Log.d("CustomeSettlement","$amountOwed")
        Log.d("CustomeSettlement","$friendUserId")


        binding.friendNameTextView.text = friendName
        binding.balanceTextView.text = "Amount Owe: $amountOwed"
